        ...
        "data": function(row, type, set) {
          if(row.permissions == -2){ //el super usuario que es el director general, tiene permisos de todo excepto editar  
            if(row.estado != 'cancelado'){//permitir cancelar en caso de que no esté cancelado
              ...
              return "<button type='button' class='btn btn-outline-dark btn-sm' id='btn-mostrar' style='margin-right: 10px' data-toggle='tooltip' data-placement='top' title='mostrar Oficio'><i class='fas fa-eye'></i></button>"
            }
