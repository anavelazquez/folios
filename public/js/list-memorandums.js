      ...
      },
      {
        "data": function (row, type, set){
          if(row.permissions == -2){ //el super usuario que es el director general, tiene permisos de todo excepto editar  
            ...
            return "<button type='button' class='btn btn-warning btn-sm' id='btn-cancelar' style='margin-left: 30px' data-toggle='tooltip' data-placement='top' title='Cancelar Memorándum'><i class='right fas fa-ban'></i></button> <button type='button' class='btn btn-danger btn-sm' id='btn-eliminar' style='margin-left: 10px' data-toggle='tooltip' data-placement='top' title='Eliminar Memorándum'><i class='right fas fa-trash-alt'></i></button>"
          }else{//En caso contrario mostrar el ojito
            return "<button type='button' class='btn btn-outline-dark btn-sm' id='btn-mostrar' style='margin-left: 45px' data-toggle='tooltip' data-placement='top' title='mostrar Memorándum'><i class='fas fa-eye'></i></button>"
          }
          ...
          if(row.estado == 'cancelado'){ //si el memorandums ya está cancelado, mostrar solo el ojito
            ...
            return "<button type='button' class='btn btn-primary btn-sm' id='btn-editar' style='margin-left: 45px' data-toggle='tooltip' data-placement='top' title='Editar Memorándum'><i class='right fas fa-edit'></i></button>" 
            }else{
            return "<button type='button' class='btn btn-outline-dark btn-sm' id='btn-mostrar' style='margin-left: 45px' data-toggle='tooltip' data-placement='top' title='mostrar Memorándum'><i class='fas fa-eye'></i></button>"
          }
        }
