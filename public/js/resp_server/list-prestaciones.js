...
$(document).ready(function () {
  ...
  modalConfirm(function(confirm){
    if(confirm){
      $.ajax({
       type:'GET',
       url: '/edictos/delete-prestacion/'+id_prestacion_demandada
     })
      .done(function( msg ) {
        table.ajax.reload();
        Toast.fire({
  ...
  $('#prestaciones-form').on('submit', function(e) {
      ...
      if(id_prestacion_demandada_editar){
          $.ajax({
           ...
           method: "POST",
           url: '/edictos/update-prestacion/'+id_prestacion_demandada_editar,
           data: formData,
           contentType: false,
           processData: false})
          .done(function (msg) {
        ...
        $.ajax({
         ...
         method: "POST",
         url: '/edictos/guardar-prestacion-demandada',
         data: formData,
         contentType: false,
         processData: false})
        .done(function (msg) {
