...
$(document).ready(function () {
  ...
  var table = $("#edictos").DataTable({
    ...
    "serverSide": true,
    "ajax": {
          "url": "/edictos/edictoslistapublicada",
          "dataSrc": "data"
          },
    "columns": [
        {
  ...
  $('#edictos').on( 'click', '#btn-mostrar-publicaciones', function () {
  ...
  //Mostrar Edicto
  $('#edictos').on( 'click', '#btn-consultar', function () {
    var data = table.row( $(this).parents('tr') ).data();
  ...
  function genera_tabla_dias(dias_publicacion, tipo_publicacion) {
    ...
    stritem += "<thead><tr><th scope='col'>Fecha Inicio</th><th scope='col'>Estado</th></tr></thead>";
    ...
    if( tipo_publicacion == 'I'){
      stritem += "<br><p><b>La publicación estará por tiempo Indefinido</b></p>";
    }
