  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Eliminar Memorándum</h5>
      ...
      <div class="modal-body">
        ¿Está seguro que desea eliminar el memorandum <span id="memorandum"></span>?
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-danger" id="eliminar-memorandum">Eliminar</button>
      </div>
...
<div class="modal fade" id="ModalEditar" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modal-label">Editar Memorándum</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form id="memorandums-form" class="form-horizontal needs-validation" enctype="multipart/form-data">
          {!! csrf_field() !!}
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
            <button type="submit" class="btn btn-success" id="editar-memorandum">Agregar</button>
          </div>
        </form>
    </div>
  </div>
...
@section('js')
  <script src="{{ asset('js/list-memorandums.js') }}"></script>
@stop