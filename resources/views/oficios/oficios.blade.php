      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body text-justify">
                  <ul>
                  <li>Medio de comunicación entre el colegio y las secretarías, dependecias, instituciones, órganos
                   externos, entre otros.</li>
                   <li>De manera interna se utiliza para comunicar disposiciones, solicitar información, atender un trámite
                   específico, orientar o atender dudas, órdenes, informes entre las diferentes áreas del colegio.</li>
                   <li>Para turnar solicitudes o requerimientos de información de una área a otra.</li>
                   <li>Solamente serán generados por las áreas del CECyTE Veracruz. <strong>(Los departamentos
                    NO pueden emitir Oficios)</strong></li>
                   <li>Se dirige de manera lineal de Dirección a Dirección y con atención al Departamento que le dará 
                   seguimiento, <strong>en caso de ser necesario.</strong></li>
                  </ul>
